...
def argmin(f, lo, hi, epsilon=1e-3):
    ...
    should look like. Your output numbers are likely to be slightly different
    due to minor implementation details. Writing tests for code that uses
...
def find_boundaries(f):
    ...
    and hi. This function is useful for initializing argmin.
